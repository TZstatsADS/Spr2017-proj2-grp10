...
output$explain2<- renderText({"1. Choose the first 3 options to do some basic filtering of schools, and obtain their rankings (based on the Forbes world ranking). View them on an interactive map, and also get a clearer picture of how certain relevant factors (i.e. Earnings, Cost of Attendance) of the school you are interested in fare in comparison to other schools from the density plots."})
output$explain3<- renderText({"2. If you feel like the Forbes ranking is not your thing, feel free to utilize our slider inputs to rate how highly you value certain aspects like safety and happiness. Obtain your own personalized ranking and compare them to the QR rankings!"})  
