...
# cut the values into quantile and then assign the color to the quantiles. 
# default color is blue and blue has 8 levels
...
# query google API to resolve an address to an longitute and altitute data
```
...
mh2009.use=
  ...
  # missing data is not necessarily NA, e.g. 99 means no answer in survey
